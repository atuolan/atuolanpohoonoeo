...
export function toSyncChatRecordPayload(chat: SyncableChatRecordSource): SyncChatRecordPayload {
  return {
    ...
    thirdPersonMode: chat.charNarrativePerson === "third" || chat.thirdPersonMode,
    charNarrativePerson: chat.charNarrativePerson,
    userNarrativePerson: chat.userNarrativePerson,
