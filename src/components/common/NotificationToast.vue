...
const typeIcons: Record<NotificationType, string> = {
  ...
  friend_request:
    "M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm6 1h-2v-2h-2v2h-2v2h2v2h2v-2h2v-2zm-6 1c-2.67 0-8 1.34-8 4v2h8.5c-.32-.62-.5-1.3-.5-2 0-1.86 1.28-3.41 3-3.86V18c0-.34.04-.67.1-1H4c0-1.5 4-3 8-3z",
  friend_accepted:
    "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15l-4-4 1.41-1.41L11 14.17l5.59-5.59L18 10l-7 7z",
  friend_rejected:
    "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.59 13.17L15.17 16.59 12 13.41 8.83 16.59 7.41 15.17 10.59 12 7.41 8.83 8.83 7.41 12 10.59 15.17 7.41 16.59 8.83 13.41 12l3.18 3.17z",
  apology_food:
    "M11 9h2V6h3l-4-4-4 4h3v3zm-6 2h14v2H5v-2zm0 4h14v2H5v-2zm0 4h14v2H5v-2z",
  char_blocked:
    "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm6.31 14.9L7.1 5.69A7.95 7.95 0 0112 4c4.42 0 8 3.58 8 8 0 1.85-.63 3.55-1.69 4.9zM4 12c0-1.85.63-3.55 1.69-4.9L16.9 18.31A7.95 7.95 0 0112 20c-4.42 0-8-3.58-8-8z",
  char_unblocked:
...
const typeColors: Record<NotificationType, string> = {
  ...
  friend_request: "#89CFF0",
  friend_accepted: "#7dd3a8",
  friend_rejected: "#f87171",
  apology_food: "#f5a9b8",
  char_blocked: "#f87171",
  char_unblocked: "#7dd3a8",
  system: "#a0aec0",
};
